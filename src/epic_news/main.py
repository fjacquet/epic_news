    ...
    def generate_deep_research(self):
        ...
        if os.path.exists(output_file):
            try:
                ...
                # extract() returns {"deep_research_model": DeepResearchReport}, not the model itself.
                extractor = DeepResearchExtractor()
                research_report_model = extractor.extract({"raw_output": json_str})["deep_research_model"]
