...
class PaprikaRecipe(BaseModel):
    ...
    servings: Union[str, None] = Field(None, description="Number of servings the recipe yields.")
    source: Union[str, None] = Field(None, description="The original source of the recipe.")
    source_url: Union[str, None] = Field(None, description="URL for the original recipe source.")
    prep_time: Union[str, None] = Field(None, description="Preparation time.")
    cook_time: Union[str, None] = Field(None, description="Cooking time.")
    on_favorites: Union[bool, None] = Field(False, description="Whether the recipe is marked as a favorite.")
    categories: list[str] = Field(default_factory=list, description="A list of categories for the recipe.")
    nutritional_info: Union[str, None] = Field(None, description="Nutritional information.")
    difficulty: Union[str, None] = Field(None, description="Difficulty level of the recipe.")
    rating: Union[int, None] = Field(None, description="Rating of the recipe from 1 to 5.")
    notes: Union[str, None] = Field(None, description="Additional notes about the recipe.")
