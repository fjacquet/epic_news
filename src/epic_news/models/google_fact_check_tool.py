...
class GoogleFactCheckInput(BaseModel):
    ...
    review_publisher_site_filter: Union[str, None] = Field(
    ...
    max_age_days: Union[int, None] = Field(
    ...
    page_token: Union[str, None] = Field(default=None, description="The pagination token.")
