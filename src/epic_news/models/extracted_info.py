...
class ExtractedInfo(BaseModel):
    ...
    main_subject_or_activity: Union[str, None] = Field(
        default=None,
    ...
    user_preferences_and_constraints: Union[str, None] = Field(
        default=None,
        description="Specific user needs, preferences, or constraints (e.g., 'vegetarian meals, window seat').",
    )
    context: Union[str, None] = Field(default=None, description="Additional context for the request.")
    objective: Union[str, None] = Field(default=None, description="The primary objective of the request.")
    target_company: Union[str, None] = Field(
        default=None,
