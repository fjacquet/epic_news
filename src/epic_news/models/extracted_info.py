...
class ExtractedInfo(BaseModel):
    ...
    context: Optional[str] = Field(default=None, description="Additional context for the request.")
    objective: Optional[str] = Field(default=None, description="The primary objective of the request.")
