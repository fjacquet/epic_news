...
class FinDailyCrew():
    ...
    def _init_tools(self):
        ...
        self.stock_tools = get_stock_research_tools() + [FileReadTool(), DirectoryReadTool(), ScrapeNinjaTool()]
        self.crypto_tools = get_crypto_research_tools() + [KrakenAssetListTool(), KrakenTickerInfoTool(), ScrapeNinjaTool()]
