...
from epic_news.tools.yahoo_finance_etf_holdings_tool import YahooFinanceETFHoldingsTool, GetETFHoldingsInput
...
def test_run_successful_all_data(mock_yf_ticker, tool_instance, mock_etf_data_all_present):
    ...
    assert result_data["sector_breakdown"] == {"Technology": 0.25, "Healthcare": 0.15, "Financial Services": 0.20}
