...
def test_dashboard_generator(mocker):
    ...
    mocker.patch(
        ...
        read_data='{"crews": {"test_crew": {"last_execution_time": 10}}}',
    )
...
def test_generate_all_dashboards(mocker):
    ...
    mocker.patch(
        "epic_news.utils.dashboard_generator.DashboardGenerator.generate_dashboard",
        return_value="test_dashboard.html",
    )
