...
📖 **Browse the docs site:** [fjacquet.github.io/epic_news](https://fjacquet.github.io/epic_news/) — auto-published from `docs/` on every push to `master`.

The source markdown lives in [`docs/`](./docs/index.md), organized in the [Diátaxis](https://diataxis.fr/) style.
